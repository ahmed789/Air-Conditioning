...
# 42 "ECU_Layer/Chr_LCD/../../MCAL_Layer/GPIO/hal_gpio.h"
typedef enum{
    LOW,
    HIGH
}logic_t;
...
# 9 "ECU_Layer/Chr_LCD/ecu_chr_lcd.c" 2
...
# 24 "ECU_Layer/Chr_LCD/ecu_chr_lcd.c"
Std_ReturnType lcd_4bit_intialize(const chr_lcd_4bit_t *lcd){
    ...
    if(((void*)0) == lcd){
        ...
        ret = gpio_pin_direction_initialize(&(lcd->lcd_rs));
        ret = gpio_pin_direction_initialize(&(lcd->lcd_en));
        for(l_data_pins_counter=0; l_data_pins_counter<4; l_data_pins_counter++){
            ret = gpio_pin_direction_initialize(&(lcd->lcd_data[l_data_pins_counter]));
        }
...
# 61 "ECU_Layer/Chr_LCD/ecu_chr_lcd.c"
Std_ReturnType lcd_4bit_send_command(const chr_lcd_4bit_t *lcd, uint8 command){
    Std_ReturnType ret = (std_ReturnType) 0x01;
    if(((void*)0) == lcd){
        ret = (std_ReturnType) 0x00;
        ...
        ret = gpio_pin_write_logic(&(lcd->lcd_rs), 0x00);
...
# 90 "ECU_Layer/Chr_LCD/ecu_chr_lcd.c"
Std_ReturnType lcd_4bit_send_char_data(const chr_lcd_4bit_t *lcd, uint8 data){
    Std_ReturnType ret = (std_ReturnType) 0x01;
    if(((void*)0) == lcd){
        ret = (std_ReturnType) 0x00;
        ...
        ret = gpio_pin_write_logic(&(lcd->lcd_rs), 0x01);
...
# 118 "ECU_Layer/Chr_LCD/ecu_chr_lcd.c"
Std_ReturnType lcd_4bit_send_char_data_pos(const chr_lcd_4bit_t *lcd,uint8 row, uint8 column, uint8 data){
    Std_ReturnType ret = (std_ReturnType) 0x01;
    if(((void*)0) == lcd){
        ret = (std_ReturnType) 0x00;
...
# 137 "ECU_Layer/Chr_LCD/ecu_chr_lcd.c"
Std_ReturnType lcd_4bit_send_string(const chr_lcd_4bit_t *lcd, uint8 *str){
    Std_ReturnType ret = (std_ReturnType) 0x01;
    if(((void*)0) == lcd){
        ret = (std_ReturnType) 0x00;
...
# 159 "ECU_Layer/Chr_LCD/ecu_chr_lcd.c"
Std_ReturnType lcd_4bit_send_string_pos(const chr_lcd_4bit_t *lcd, uint8 row, uint8 column, uint8 *str){
    Std_ReturnType ret = (std_ReturnType) 0x01;
    if(((void*)0) == lcd){
        ret = (std_ReturnType) 0x00;
...
# 183 "ECU_Layer/Chr_LCD/ecu_chr_lcd.c"
Std_ReturnType lcd_4bit_send_custom_char(const chr_lcd_4bit_t *lcd, uint8 row, uint8 column,
                                         const uint8 _chr[], uint8 mem_pos){
    Std_ReturnType ret = (std_ReturnType) 0x01;
    uint8 lcd_counter = 0;
...
# 208 "ECU_Layer/Chr_LCD/ecu_chr_lcd.c"
Std_ReturnType lcd_8bit_intialize(const chr_lcd_8bit_t *lcd){
    Std_ReturnType ret = (std_ReturnType) 0x01;
    uint8 l_data_pins_counter = 0;
    if(((void*)0) == lcd){
...
# 266 "ECU_Layer/Chr_LCD/ecu_chr_lcd.c"
Std_ReturnType lcd_8bit_send_char_data(const chr_lcd_8bit_t *lcd, uint8 data){
    Std_ReturnType ret = (std_ReturnType) 0x01;
    uint8 l_pin_counter = 0;
    if(((void*)0) == lcd){
...
# 296 "ECU_Layer/Chr_LCD/ecu_chr_lcd.c"
Std_ReturnType lcd_8bit_send_char_data_pos(const chr_lcd_8bit_t *lcd,uint8 row, uint8 column, uint8 data){
    Std_ReturnType ret = (std_ReturnType) 0x01;
    if(((void*)0) == lcd){
        ret = (std_ReturnType) 0x00;
...
# 316 "ECU_Layer/Chr_LCD/ecu_chr_lcd.c"
Std_ReturnType lcd_8bit_send_string(const chr_lcd_8bit_t *lcd, uint8 *str){
    Std_ReturnType ret = (std_ReturnType) 0x01;
    if(((void*)0) == lcd){
        ret = (std_ReturnType) 0x00;
...
# 338 "ECU_Layer/Chr_LCD/ecu_chr_lcd.c"
Std_ReturnType lcd_8bit_send_string_pos(const chr_lcd_8bit_t *lcd, uint8 row, uint8 column, uint8 *str){
    Std_ReturnType ret = (std_ReturnType) 0x01;
    if(((void*)0) == lcd){
        ret = (std_ReturnType) 0x00;
...
# 360 "ECU_Layer/Chr_LCD/ecu_chr_lcd.c"
Std_ReturnType lcd_8bit_send_custom_char(const chr_lcd_8bit_t *lcd, uint8 row, uint8 column,
                                         const uint8 _chr[], uint8 mem_pos){
    Std_ReturnType ret = (std_ReturnType) 0x01;
    uint8 lcd_counter = 0;
...
# 385 "ECU_Layer/Chr_LCD/ecu_chr_lcd.c"
Std_ReturnType convert_uint8_to_string(uint8 value, uint8 *str){
    Std_ReturnType ret = (std_ReturnType) 0x01;
    if(((void*)0) == str){
        ret = (std_ReturnType) 0x00;
...
# 404 "ECU_Layer/Chr_LCD/ecu_chr_lcd.c"
Std_ReturnType convert_uint16_to_string(uint16 value, uint8 *str){
    Std_ReturnType ret = (std_ReturnType) 0x01;
...
# 430 "ECU_Layer/Chr_LCD/ecu_chr_lcd.c"
Std_ReturnType convert_uint32_to_string(uint32 value, uint8 *str){
    Std_ReturnType ret = (std_ReturnType) 0x01;
    if(((void*)0) == str){
        ret = (std_ReturnType) 0x00;
...
# 451 "ECU_Layer/Chr_LCD/ecu_chr_lcd.c"
static Std_ReturnType lcd_send_4bits(const chr_lcd_4bit_t *lcd, uint8 _data_command){
    Std_ReturnType ret = (std_ReturnType) 0x01;
...
# 467 "ECU_Layer/Chr_LCD/ecu_chr_lcd.c"
static Std_ReturnType lcd_4bit_send_enable_signal(const chr_lcd_4bit_t *lcd){
    Std_ReturnType ret = (std_ReturnType) 0x01;
    ret = gpio_pin_write_logic(&(lcd->lcd_en), 0x01);
    _delay((unsigned long)((5)*(8000000/4000000.0)));
    ret = gpio_pin_write_logic(&(lcd->lcd_en), 0x00);
    return ret;
}
# 482 "ECU_Layer/Chr_LCD/ecu_chr_lcd.c"
static Std_ReturnType lcd_8bit_send_enable_signal(const chr_lcd_8bit_t *lcd){
    Std_ReturnType ret = (std_ReturnType) 0x01;
    ret = gpio_pin_write_logic(&(lcd->lcd_en), 0x01);
    _delay((unsigned long)((5)*(8000000/4000000.0)));
...
static Std_ReturnType lcd_8bit_set_cursor(const chr_lcd_8bit_t *lcd, uint8 row, uint8 coulmn){
    ...
    coulmn--;
    switch(row){
        case 1 : ret = lcd_8bit_send_command(lcd, (0x80 + coulmn)); break;
        case 2 : ret = lcd_8bit_send_command(lcd, (0xc0 + coulmn)); break;
        case 3 : ret = lcd_8bit_send_command(lcd, (0x94 + coulmn)); break;
        case 4 : ret = lcd_8bit_send_command(lcd, (0xd4 + coulmn)); break;
        default : ;
    }
    return ret;
}
# 521 "ECU_Layer/Chr_LCD/ecu_chr_lcd.c"
static Std_ReturnType lcd_4bit_set_cursor(const chr_lcd_4bit_t *lcd, uint8 row, uint8 coulmn){
    Std_ReturnType ret = (std_ReturnType) 0x01;
    coulmn--;
    switch(row){
        case 1 : ret = lcd_4bit_send_command(lcd, (0x80 + coulmn)); break;
        case 2 : ret = lcd_4bit_send_command(lcd, (0xc0 + coulmn)); break;
        case 3 : ret = lcd_4bit_send_command(lcd, (0x94 + coulmn)); break;
        case 4 : ret = lcd_4bit_send_command(lcd, (0xd4 + coulmn)); break;
        default : ;
    }
    return ret;
}
