...
# 42 "ECU_Layer/DC_Motor/../../MCAL_Layer/GPIO/hal_gpio.h"
typedef enum{
    LOW,
    HIGH
}logic_t;
...
# 7 "ECU_Layer/DC_Motor/ecu_dc_motor.c" 2
# 17 "ECU_Layer/DC_Motor/ecu_dc_motor.c"
std_ReturnType dc_motor_initialize(const dc_motor_t *_dc_motor){
     ...
     if(((void*)0) == _dc_motor){
        ...
        gpio_pin_initialize(&(_dc_motor->dc_motor_pin[0x00U]));
        gpio_pin_initialize(&(_dc_motor->dc_motor_pin[0x01U]));
    }
     return ret;
}
# 36 "ECU_Layer/DC_Motor/ecu_dc_motor.c"
std_ReturnType dc_motor_move_right(const dc_motor_t *_dc_motor){
     std_ReturnType ret = (std_ReturnType) 0x01;
     if(((void*)0) == _dc_motor){
        ret = (std_ReturnType) 0x00;
        ...
        gpio_pin_write_logic(&(_dc_motor->dc_motor_pin[0x00U]), HIGH);
        gpio_pin_write_logic(&(_dc_motor->dc_motor_pin[0x01U]), LOW);
    }
     return ret;
}
# 55 "ECU_Layer/DC_Motor/ecu_dc_motor.c"
std_ReturnType dc_motor_move_left(const dc_motor_t *_dc_motor){
     std_ReturnType ret = (std_ReturnType) 0x01;
     if(((void*)0) == _dc_motor){
        ret = (std_ReturnType) 0x00;
        ...
        gpio_pin_write_logic(&(_dc_motor->dc_motor_pin[0x00U]), LOW);
        gpio_pin_write_logic(&(_dc_motor->dc_motor_pin[0x01U]), HIGH);
    }
     return ret;
}
# 74 "ECU_Layer/DC_Motor/ecu_dc_motor.c"
std_ReturnType dc_motor_stop(const dc_motor_t *_dc_motor){
     std_ReturnType ret = (std_ReturnType) 0x01;
     if(((void*)0) == _dc_motor){
        ret = (std_ReturnType) 0x00;
