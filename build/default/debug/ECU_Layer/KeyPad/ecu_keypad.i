...
# 42 "ECU_Layer/KeyPad/../../MCAL_Layer/GPIO/hal_gpio.h"
typedef enum{
    LOW,
    HIGH
}logic_t;
...
# 50 "ECU_Layer/KeyPad/ecu_keypad.c"
Std_ReturnType keypad_get_value(const keypad_t *_keypad_obj, uint8 *value){
    Std_ReturnType ret = (std_ReturnType) 0x01;
    ...
    if((((void*)0) == _keypad_obj) || (((void*)0) == value)){
        ...
        for(l_rows_counter=0; l_rows_counter<4; l_rows_counter++){
            for(l_counter=0; l_counter<4; l_counter++){
                ret = gpio_pin_write_logic(&(_keypad_obj->keypad_row_pins[l_counter]), 0x00);
            }
            gpio_pin_write_logic(&(_keypad_obj->keypad_row_pins[l_rows_counter]), 0x01);
