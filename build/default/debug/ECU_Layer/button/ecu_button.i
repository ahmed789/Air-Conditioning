...
# 42 "ECU_Layer/button/../../MCAL_Layer/GPIO/hal_gpio.h"
typedef enum{
    LOW,
    HIGH
}logic_t;
...
# 9 "ECU_Layer/button/ecu_button.c" 2
# 18 "ECU_Layer/button/ecu_button.c"
std_ReturnType button_initialize(const button_t *btn){
...
# 37 "ECU_Layer/button/ecu_button.c"
...
std_ReturnType ret = (std_ReturnType) 0x00;
 logic_t Pin_Logic_Status = LOW;
    ...
    else gpio_pin_read_logic(&(btn->button_pin), &Pin_Logic_Status);
