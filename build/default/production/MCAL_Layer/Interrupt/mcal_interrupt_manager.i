...
void __attribute__((picinterrupt(("")))) InterruptManager(void){
    ...
    if((1 == INTCONbits.RBIE) && (1 == INTCONbits.RBIF) &&
       (PORTBbits.RB4 == 0x01) && (RB4_Flag == 1)){
        RB4_Flag = 0;
        RB4_ISR(0);
    }
    else{ }
    if((1 == INTCONbits.RBIE) && (1 == INTCONbits.RBIF) &&
       (PORTBbits.RB4 == 0x00) && (RB4_Flag == 0)){
        RB4_Flag = 1;
        RB4_ISR(1);
    }
    else{ }
    if((1 == INTCONbits.RBIE) && (1 == INTCONbits.RBIF) &&
       (PORTBbits.RB5 == 0x01) && (RB5_Flag == 1)){
        RB5_Flag = 0;
        RB5_ISR(0);
    }
    else{ }
    if((1 == INTCONbits.RBIE) && (1 == INTCONbits.RBIF) &&
       (PORTBbits.RB5 == 0x00) && (RB5_Flag == 0)){
        RB5_Flag = 1;
        RB5_ISR(1);
    }
    else{ }
    if((1 == INTCONbits.RBIE) && (1 == INTCONbits.RBIF) &&
       (PORTBbits.RB6 == 0x01) && (RB6_Flag == 1)){
        RB6_Flag = 0;
        RB6_ISR(0);
    }
    else{ }
    if((1 == INTCONbits.RBIE) && (1 == INTCONbits.RBIF) &&
       (PORTBbits.RB6 == 0x00) && (RB6_Flag == 0)){
        RB6_Flag = 1;
        RB6_ISR(1);
    }
    else{ }
    if((1 == INTCONbits.RBIE) && (1 == INTCONbits.RBIF) &&
       (PORTBbits.RB7 == 0x01) && (RB7_Flag == 1)){
        RB7_Flag = 0;
        RB7_ISR(0);
    }
    else{ }
    if((1 == INTCONbits.RBIE) && (1 == INTCONbits.RBIF) &&
       (PORTBbits.RB7 == 0x00) && (RB7_Flag == 0)){
        RB7_Flag = 1;
        RB7_ISR(1);
    }
    else{ }
