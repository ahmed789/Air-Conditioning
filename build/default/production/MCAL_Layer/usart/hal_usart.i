...
# 1 "MCAL_Layer/usart/../mcal_std_types.h" 1
# 12 "MCAL_Layer/usart/../mcal_std_types.h"
...
# 12 "MCAL_Layer/usart/../mcal_std_types.h" 2

# 1 "MCAL_Layer/usart/../compiler.h" 1
# 11 "MCAL_Layer/usart/../compiler.h"
...
# 11 "MCAL_Layer/usart/../compiler.h" 2
# 13 "MCAL_Layer/usart/../mcal_std_types.h" 2
...
# 15 "MCAL_Layer/usart/../Interrupt/mcal_interrupt_config.h"
# 1 "MCAL_Layer/usart/../Interrupt/mcal_interrupt_gen_cfg.h" 1
# 15 "MCAL_Layer/usart/../Interrupt/mcal_interrupt_config.h" 2
# 54 "MCAL_Layer/usart/../Interrupt/mcal_interrupt_config.h"
typedef enum{
...
static void EUSART_Baud_Rate_Calculation(const usart_t *_eusart){
    ...
    switch(_eusart->baudrate_gen_gonfig){
        case BAUDRATE_ASYN_8BIT_lOW_SPEED:
            ...
            TXSTAbits.BRGH = 0;
            BAUDCONbits.BRG16 = 0;
            Baud_Rate_Temp = ((8000000 / (float)_eusart->baudrate) / 64) - 1;
            break;
        case BAUDRATE_ASYN_8BIT_HIGH_SPEED:
            TXSTAbits.SYNC = 0;
            TXSTAbits.BRGH = 1;
            BAUDCONbits.BRG16 = 0;
            Baud_Rate_Temp = ((8000000 / (float)_eusart->baudrate) / 16) - 1;
            break;
        ...
        case BAUDRATE_ASYN_16BIT_HIGH_SPEED:
            ...
            TXSTAbits.BRGH = 1;
            BAUDCONbits.BRG16 = 1;
            Baud_Rate_Temp = ((8000000 / (float)_eusart->baudrate) / 4) - 1;
            break;
